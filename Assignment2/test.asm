...
int main() {
  ...
  11:	6a 01                	push   $0x1
  13:	6a 01                	push   $0x1
  15:	e8 00 03 00 00       	call   31a <sigsend>
  1a:	83 c4 0c             	add    $0xc,%esp
  1d:	50                   	push   %eax
  1e:	68 f0 06 00 00       	push   $0x6f0
  23:	6a 01                	push   $0x1
  25:	e8 a6 03 00 00       	call   3d0 <printf>



    exit();
  2a:	e8 43 02 00 00       	call   272 <exit>
  2f:	90                   	nop
...
putc(int fd, char c)
{
 ...
 4e8:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 4eb:	b8 f9 06 00 00       	mov    $0x6f9,%eax
