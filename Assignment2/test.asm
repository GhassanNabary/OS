...
main(int argc, char *argv[]){
  ...
  for(p = 0; p < 50*500000; p++){
    if((p++ % 500000) == 0)
  10:	be 83 de 1b 43       	mov    $0x431bde83,%esi
 //printf(1,"\n=======================Signal Handler===================================\n Process id:  %d  Signal number: %d \n\n", getpid(),sigNum);
}
...
signal(14,handler);
  18:	68 a0 00 00 00       	push   $0xa0
  1d:	6a 0e                	push   $0xe
  1f:	e8 8e 03 00 00       	call   3b2 <signal>
//sleep(5);
//printf(1,"pid is %d\n",getpid() );
  int p;
  printf(1, " start  alarmtest \n");
  24:	58                   	pop    %eax
  25:	5a                   	pop    %edx
  26:	68 ba 07 00 00       	push   $0x7ba
  2b:	6a 01                	push   $0x1
  2d:	e8 4e 04 00 00       	call   480 <printf>
  alarm(100);
  32:	c7 04 24 64 00 00 00 	movl   $0x64,(%esp)
  39:	e8 8c 03 00 00       	call   3ca <alarm>
  printf(1, "\n alarm_Hendler \n");
  3e:	59                   	pop    %ecx
  3f:	5b                   	pop    %ebx
  40:	68 ce 07 00 00       	push   $0x7ce
  45:	6a 01                	push   $0x1
  for(p = 0; p < 50*500000; p++){
...
//printf(1,"pid is %d\n",getpid() );
  ...
  alarm(100);
  printf(1, "\n alarm_Hendler \n");
  49:	e8 32 04 00 00       	call   480 <printf>
  4e:	83 c4 10             	add    $0x10,%esp
  51:	eb 10                	jmp    63 <main+0x63>
  53:	90                   	nop
  54:	8d 74 26 00          	lea    0x0(%esi,%eiz,1),%esi
  for(p = 0; p < 50*500000; p++){
  58:	83 c3 02             	add    $0x2,%ebx
  5b:	81 fb 40 78 7d 01    	cmp    $0x17d7840,%ebx
  61:	74 37                	je     9a <main+0x9a>
    if((p++ % 500000) == 0)
  63:	89 d8                	mov    %ebx,%eax
  65:	f7 ee                	imul   %esi
  67:	89 d8                	mov    %ebx,%eax
  69:	c1 f8 1f             	sar    $0x1f,%eax
  6c:	c1 fa 11             	sar    $0x11,%edx
  6f:	29 c2                	sub    %eax,%edx
  71:	69 d2 20 a1 07 00    	imul   $0x7a120,%edx,%edx
  77:	39 d3                	cmp    %edx,%ebx
  79:	75 dd                	jne    58 <main+0x58>
      write(2, ".", 1);
...
//printf(1,"pid is %d\n",getpid() );
  ...
  printf(1, "\n alarm_Hendler \n");
  for(p = 0; p < 50*500000; p++){
  7e:	83 c3 02             	add    $0x2,%ebx
    if((p++ % 500000) == 0)
      write(2, ".", 1);
  81:	6a 01                	push   $0x1
  83:	68 e0 07 00 00       	push   $0x7e0
  88:	6a 02                	push   $0x2
...
//printf(1,"pid is %d\n",getpid() );
  ...
  printf(1, "\n alarm_Hendler \n");
  for(p = 0; p < 50*500000; p++){
  92:	81 fb 40 78 7d 01    	cmp    $0x17d7840,%ebx
...
test(int sigNum){
 ...
 sighandler_t handler=(sighandler_t)test;
signal(14,handler);
  a6:	68 a0 00 00 00       	push   $0xa0
  ab:	6a 0e                	push   $0xe
  ad:	e8 00 03 00 00       	call   3b2 <signal>
 printf(1, "\n fucking alarm_Hendler \n");
  b2:	58                   	pop    %eax
  b3:	5a                   	pop    %edx
  b4:	68 a0 07 00 00       	push   $0x7a0
  b9:	6a 01                	push   $0x1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 41f:	f7 f6                	div    %esi
 421:	0f b6 92 ec 07 00 00 	movzbl 0x7ec(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 598:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 59b:	b8 e2 07 00 00       	mov    $0x7e2,%eax
...
free(void *ap)
{
 ...
 677:	89 08                	mov    %ecx,(%eax)
  freep = p;
 679:	a3 ac 0a 00 00       	mov    %eax,0xaac
}
 67e:	5b                   	pop    %ebx
 67f:	5e                   	pop    %esi
 680:	5f                   	pop    %edi
 ...
 69a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 69d:	a3 ac 0a 00 00       	mov    %eax,0xaac
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 6b9:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 6bc:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 70f:	76 3f                	jbe    750 <malloc+0xa0>
    ...
    if(p == freep)
 711:	39 05 ac 0a 00 00    	cmp    %eax,0xaac
 ...
 736:	e8 e5 fe ff ff       	call   620 <free>
  return freep;
 73b:	8b 15 ac 0a 00 00    	mov    0xaac,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 75c:	89 78 04             	mov    %edi,0x4(%eax)
      ...
      freep = prevp;
 75f:	89 15 ac 0a 00 00    	mov    %edx,0xaac
      return (void*)(p + 1);
 ...
 774:	eb e9                	jmp    75f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 776:	c7 05 ac 0a 00 00 b0 	movl   $0xab0,0xaac
 77d:	0a 00 00 
 780:	c7 05 b0 0a 00 00 b0 	movl   $0xab0,0xab0
 787:	0a 00 00 
    base.s.size = 0;
 78a:	b8 b0 0a 00 00       	mov    $0xab0,%eax
 78f:	c7 05 b4 0a 00 00 00 	movl   $0x0,0xab4
 796:	00 00 00 
