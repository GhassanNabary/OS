...
printf(1,"------------------TestEx1----------------- \n");
  ...
  14:	68 f4 07 00 00       	push   $0x7f4
  19:	6a 01                	push   $0x1
  1b:	e8 40 04 00 00       	call   460 <printf>
...
for(int i=0;i<32;i++){
 printf(1,"test  for1: i=%d\n",i);
  ...
  2b:	53                   	push   %ebx
  2c:	68 24 08 00 00       	push   $0x824
  31:	6a 01                	push   $0x1
  33:	e8 28 04 00 00       	call   460 <printf>
 signal(i,handler);
  38:	58                   	pop    %eax
  39:	5a                   	pop    %edx
  3a:	68 a0 00 00 00       	push   $0xa0
  3f:	53                   	push   %ebx
int
main(int argc, char *argv[]){
int j;
...
for(int i=0;i<32;i++){
 ...
 printf(1,"test  for1: i=%d\n",i);
 signal(i,handler);
  43:	e8 5a 03 00 00       	call   3a2 <signal>
int
main(int argc, char *argv[]){
int j;
printf(1,"------------------TestEx1----------------- \n");
...
for(int j=0;j<32;j++){
 sigsend(getpid(),j);
  58:	e8 25 03 00 00       	call   382 <getpid>
...
for(int j=0;j<32;j++){
 ...
 sigsend(getpid(),j);
  65:	e8 40 03 00 00       	call   3aa <sigsend>
for(int i=0;i<32;i++){
 printf(1,"test  for1: i=%d\n",i);
 signal(i,handler);
}
...
for(j=0; j<15; j++)
  ...
  83:	6a 01                	push   $0x1
  85:	e8 08 03 00 00       	call   392 <sleep>
}
...
test(int sigNum){
 ...
 printf(1,"\n=======================Signal Handler===================================\n Process id:  %d  Signal number: %d \n\n", getpid(),sigNum);
  a6:	e8 d7 02 00 00       	call   382 <getpid>
  ab:	ff 75 08             	pushl  0x8(%ebp)
  ae:	50                   	push   %eax
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3ff:	f7 f6                	div    %esi
 401:	0f b6 92 40 08 00 00 	movzbl 0x840(%edx),%edx
  }while((x /= base) != 0);
...
putc(int fd, char c)
{
 ...
 578:	89 45 d0             	mov    %eax,-0x30(%ebp)
        if(s == 0)
          s = "(null)";
 57b:	b8 36 08 00 00       	mov    $0x836,%eax
...
free(void *ap)
{
 ...
 657:	89 08                	mov    %ecx,(%eax)
  freep = p;
 659:	a3 fc 0a 00 00       	mov    %eax,0xafc
}
 65e:	5b                   	pop    %ebx
 65f:	5e                   	pop    %esi
 660:	5f                   	pop    %edi
 ...
 67a:	03 53 fc             	add    -0x4(%ebx),%edx
    ...
    p->s.ptr = bp;
  freep = p;
 67d:	a3 fc 0a 00 00       	mov    %eax,0xafc
    bp->s.size += p->s.ptr->s.size;
    bp->s.ptr = p->s.ptr->s.ptr;
  } else
    bp->s.ptr = p->s.ptr;
...
malloc(uint nbytes)
{
 ...
 699:	8b 45 08             	mov    0x8(%ebp),%eax
  if((prevp = freep) == 0){
 69c:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
malloc(uint nbytes)
{
  Header *p, *prevp;
  uint nunits;
 ...
 6ef:	76 3f                	jbe    730 <malloc+0xa0>
    ...
    if(p == freep)
 6f1:	39 05 fc 0a 00 00    	cmp    %eax,0xafc
 ...
 716:	e8 e5 fe ff ff       	call   600 <free>
  return freep;
 71b:	8b 15 fc 0a 00 00    	mov    0xafc,%edx
      }
      freep = prevp;
      return (void*)(p + 1);
    }
 ...
 754:	eb e9                	jmp    73f <malloc+0xaf>
  ...
  if((prevp = freep) == 0){
    base.s.ptr = freep = prevp = &base;
 756:	c7 05 fc 0a 00 00 00 	movl   $0xb00,0xafc
 75d:	0b 00 00 
 760:	c7 05 00 0b 00 00 00 	movl   $0xb00,0xb00
 767:	0b 00 00 
    base.s.size = 0;
 76a:	b8 00 0b 00 00       	mov    $0xb00,%eax
 76f:	c7 05 04 0b 00 00 00 	movl   $0x0,0xb04
 776:	00 00 00 
